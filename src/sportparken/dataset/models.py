...
class HuurderObjectRelation(models.Model):
	tid = models.AutoField(primary_key=True)
	huurder = models.ForeignKey(Huurder, related_name='ho_set', on_delete=models.CASCADE)
	sportpark_object = models.ForeignKey(SportparkObject, related_name='ho_set', on_delete=models.CASCADE)
...
class SportparkGeometry(ObjectGeometry):
	sportpark = models.ForeignKey(Sportpark, related_name='object_geometry_set', on_delete=models.CASCADE)
...
class SportparkObjectGeometry(ObjectGeometry):
	sportparkObject = models.ForeignKey(SportparkObject, related_name='object_geometry_set', on_delete=models.CASCADE)
	ondergrond = models.ForeignKey(Ondergrond, related_name='object_geometry_set', on_delete=models.CASCADE)
